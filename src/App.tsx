  ...
  return <div className="app-shell">
    ...
    <main>
      ...
      <div className="mode-switch" role="tablist" aria-label="作成モード">
        ...
        <button role="tab" aria-selected={mode==='style'} className={mode==='style'?'active':''} onClick={()=>{setMode('style');setActiveId('style-glow');setStyleParts(['光の美しさ','瞳のテイスト','色彩','線画']);setStyleStrength(3);setTextMode('none');setStyleRecompose(true);setThumbnailMode(true)}}><ArrowLeftRight size={17}/><span><b>2枚でテイスト変換</b><small>別画像の色・質感を参考にする</small></span></button>
      </div>
